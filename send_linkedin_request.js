...
Linkedin = {
    config: {
        ...
        addNote: true,
        note: `Hi {{name}},
Hope you're well! I'm looking to expand my network and explore job opportunities. Would love to connect!
Resume : https://shorturl.at/u7cki
Cheers,
Vishnu`
    },
    ...
    nextPage: function (config) {
        ...
        // Dispatch the event
        pagerButton[0].children[0].dispatchEvent(event);
